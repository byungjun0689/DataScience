...
customer <- read.csv("data/Customer master.csv",stringsAsFactors = T)
...
timezone <- read.csv("data/timezone.csv", stringsAsFactors = F)
...
# write.csv(customer,"data/Customer master2.csv",row.names = F)

orderlist <- read.csv("data/6 month history of customer orders.csv")
...
product <- read.csv("data/Product master2.csv",stringsAsFactors = T)

air_product <- read.csv("data/Product airtime.csv", stringsAsFactors = F)
...
# write.csv(order_df,"data/pre_order_data.csv",row.names = F)

order_df <- read.csv("data/pre_order_data.csv", stringsAsFactors = F)
