...
NP_test <- read.csv("다변량 기말준비2.csv", header = TRUE)
...
# 개별 Hist
########################################################
ggplot(NP_test[,c(3,89)], aes(x=MMSE)) + 
  geom_histogram(aes(y=..density..), colour="black", fill="lightgreen", bins = 30)+
  geom_density(alpha=.2, fill="#FF6666") 
ggplot(NP_test[,c(3,106)], aes(x=KDSQ_total)) + 
  geom_histogram(aes(y=..density..), colour="black", fill="lightyellow", bins = 30)+
  geom_density(alpha=.2, fill="#FF6666") 
ggplot(NP_test[,c(3,107)], aes(x=SIADL_total)) + 
  geom_histogram(aes(y=..density..), colour="black", fill="lightgreen", bins = 30)+
  geom_density(alpha=.2, fill="#FF6666") 
ggplot(NP_test[,c(3,108)], aes(x=NPI_total)) + 
  geom_histogram(aes(y=..density..), colour="black", fill="lightgreen", bins = 20)+
  geom_density(alpha=.2, fill="#FF6666") 
ggplot(NP_test[,c(3,109)], aes(x=KGDS_total)) + 
  geom_histogram(aes(y=..density..), colour="black", fill="lightgreen", bins = 15)+
  geom_density(alpha=.2, fill="#FF6666") 
...
# Dx에 따른 Hist_투며
########################################################
ggplot(NP_test[,c(3,89)], aes(x=MMSE, color=Dx)) +
  geom_histogram(fill="white", alpha=0.5, position="identity", bins = 30)
ggplot(NP_test[,c(3,106)], aes(x=KDSQ_total, color=Dx)) +
  geom_histogram(fill="white", alpha=0.5, position="identity", bins = 30)
ggplot(NP_test[,c(3,107)], aes(x=SIADL_total, color=Dx)) +
  geom_histogram(fill="white", alpha=0.5, position="identity", bins = 30)
ggplot(NP_test[,c(3,108)], aes(x=NPI_total, color=Dx)) +
  geom_histogram(fill="white", alpha=0.5, position="identity", bins = 20)
ggplot(NP_test[,c(3,109)], aes(x=KGDS_total, color=Dx)) +
  geom_histogram(fill="white", alpha=0.5, position="identity", bins = 15)
...
## 2-1. Demographic data와 MMSE의 관계
...
## 2-2. Demographic data와 KDSQE의 관계
...
## 2-3. Demographic data와 SIAL의 관계
...
## 2-5. Demographic data와 KGDS의 관계
...
########################################################
# 위의 성별, 나이별, 학력별 그래프_빈도....
########################################################
ggplot(data = NP_test, aes(x = Dx, fill = Gender)) +
  geom_bar() + 
  theme_bw()

age.means <- aggregate(Age ~  Dx, NP_test, mean)
ggplot(data=NP_test, aes(x=Dx, y=Age, fill=Age)) + geom_boxplot()+
  stat_summary(fun.y=age.means, colour="darkred", geom="point", 
               shape=18, size=3) + 
  geom_text(data = age.means, aes(label = Age, y = Age + 0.08))

edu.means <- aggregate(Education ~  Dx, NP_test, mean)
ggplot(data=NP_test, aes(x=Dx, y=Education, fill=Education)) + geom_boxplot()+
  stat_summary(fun.y=edu.means, colour="darkred", geom="point", 
               shape=18, size=3) + 
  geom_text(data = edu.means, aes(label = Education, y = Education + 0.08))



## 3-2. 진단명에 따른 clinical findings (2)
par(mfrow = c(3, 4))
...
# 위의 성별, 나이별, 학력별 그래프_빈도....
########################################################
ggplot(data = NP_test, aes(x = Dx, fill = Smoking)) +
  geom_bar() + 
  theme_bw()

ggplot(data = NP_test, aes(x = Dx, fill = FHx_dementia)) +
  geom_bar() + 
  theme_bw()

ggplot(data = NP_test, aes(x = Dx, fill = Diabetes)) +
  geom_bar() + 
  theme_bw()

ggplot(data = NP_test, aes(x = Dx, fill = HTN)) +
  geom_bar() + 
  theme_bw()

ggplot(data = NP_test, aes(x = Dx, fill = Dyslipid)) +
  geom_bar() + 
  theme_bw()

ggplot(data = NP_test, aes(x = Dx, fill = Heart)) +
  geom_bar() + 
  theme_bw()

ggplot(data = NP_test, aes(x = Dx, fill = Stroke)) +
  geom_bar() + 
  theme_bw()
...
# 위의 Boxplot 변환
########################################################
ggplot(NP_test, aes(x=Dx, y=MMSE, color=Dx, group=Dx)) +
...
ggplot(NP_test, aes(x=Dx, y=KDSQ_total, color=Dx, group=Dx)) +
  geom_point(position=position_jitter(width=0.3), alpha=0.03) +
  geom_boxplot(size=1.4,alpha=0, outlier.size=0) +
  geom_boxplot(size=1.4,alpha=0, outlier.size=0, color=alpha("black",0.3))

ggplot(NP_test, aes(x=Dx, y=SIADL_total, color=Dx, group=Dx)) +
  geom_point(position=position_jitter(width=0.3), alpha=0.03) +
  geom_boxplot(size=1.4,alpha=0, outlier.size=0) +
  geom_boxplot(size=1.4,alpha=0, outlier.size=0, color=alpha("black",0.3))

ggplot(NP_test, aes(x=Dx, y=NPI_total, color=Dx, group=Dx)) +
  geom_point(position=position_jitter(width=0.3), alpha=0.03) +
  geom_boxplot(size=1.4,alpha=0, outlier.size=0) +
  geom_boxplot(size=1.4,alpha=0, outlier.size=0, color=alpha("black",0.3))

ggplot(NP_test, aes(x=Dx, y=KGDS_total, color=Dx, group=Dx)) +
  geom_point(position=position_jitter(width=0.3), alpha=0.03) +
  geom_boxplot(size=1.4,alpha=0, outlier.size=0) +
  geom_boxplot(size=1.4,alpha=0, outlier.size=0, color=alpha("black",0.3))

## 4-1. MMSE의 Factor analysis를 통한 structure확인
par(mfrow = c(1, 1))
(MMSE_fa <- fa(scale(NP_test[59:88]),8))
fa.diagram(MMSE_fa, sort=FALSE)

## 4-2. KDSQ의 Factor analysis를 통한 structure확인 
(KDSQ_fa <- fa(scale(NP_test[17:31]),3))
fa.diagram(KDSQ_fa, sort=FALSE)

## 4-3. NPI의 Factor analysis를 통한 structure확인
